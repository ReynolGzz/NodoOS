    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-1 text-sm">Kitchen Display Setup</p>
        </div>

        <div className="bg-gray-900 rounded-3xl p-6 border border-gray-800 space-y-4">
          <div>
            <label className="text-xs font-medium text-gray-400 block mb-1.5">Branch ID</label>
            <input
              value={branchId}
          ...
          <div>
            <label className="text-xs font-medium text-gray-400 block mb-1.5">Kitchen Token</label>
            <input
              type="password"
              value={token}
